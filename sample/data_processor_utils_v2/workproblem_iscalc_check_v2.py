...
# test
baseurl = "https://ailearn.chengjiukehu.com/alv-automath-service-web"

#prod
# baseurl = "https://api.tipaipai.com/alv-automath-service-web"
check_question_api = baseurl + "/v1/application/check"
push_question_api = baseurl + "/v1/application/push"
query_res_question_api = baseurl + "/v1/application/res"
...
class ApplicationAutoDemo():
    ...
    def check_question_context(self,questionDetail):
        ...
        jsonBody = {"question": questionDetail[1]}
        ...
        isCalc_ = None
        video_url_ = None
        module_id_ = questionDetail[0]
        if (resDic['code'] == 0):
            # module_id_ = resDic['data']['module_id']
            isCalc_ = resDic['data']['is_calc']
            video_url_ = resDic['data']['video_url']

        return module_id_,questionDetail[1], isCalc_, \
               resDic['code'], resDic['msg'], video_url_
    ...
    def check_question_context_batch(self):
        ...
        qDict = CSVUtil.read_questions("wordproblem_qlist_detail.csv")
        # {'code': 0, 'msg': 'success', 'data': {'is_calc': False, 'video_url': '', 'module_id': ''}
        res_file = "result/wordproblem_check_res_v20211025_prod.csv"
